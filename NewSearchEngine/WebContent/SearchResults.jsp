<%@page import="controller.cacheFormer"%>
<%@page import="nu.xom.jaxen.function.CeilingFunction"%>
<%@page import="java.util.ArrayList"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"
     import="java.util.*,controller.URL_Data" 
...
<form action="<%=request.getContextPath()%>/queryProcessor" method="get" id="SearchResults">
...
for(int i=pageid-1 ;i<end;i++){  
	urlObj=cacheFormer.getCacheData(i);
	if(urlObj!=null)
	{
	...
	{
		out.print("No resul to be printed");
	}	
}	
String stingpageNum=request.getParameter("pagenum");  
int pageNum=Integer.parseInt(stingpageNum); 

double sizee=pageNum/ 10;
double pageNum2=(Math.ceil(sizee));
request.setAttribute("pagenum",stingpageNum);
for(int i=1 ;i<=pageNum2;i++){  	
    out.print("<a href=SearchResults.jsp?page="+i+"> "+i +" </a>");  
}
